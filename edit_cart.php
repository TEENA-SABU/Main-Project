...
<body>
    ...
    if (isset($_POST["edit_id"])) {
        $_SESSION['cart_id'] = $_POST["edit_id"];
    }
    ...
    ?>
                <form class="form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" class="login-input" name="item_name" value="<?php echo $eachProduct['item_name']; ?>" placeholder="product name" required />
                    <input type="text" class="login-input" name="total_item" value="<?php echo $eachProduct['total_item']; ?>" placeholder="price" required />
